...
namespace EntityFramework.V70.Relationships;
...
public class OneToOne
{
    ...
    public class RequiredPkToPk
    {
        ...
        public class BlogContext0 : DbContext
        {
            ...
            protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
                => optionsBuilder.UseSqlite($"DataSource = ./Sqlite3/RequiredPkToPk{GetType().Name}.db");
    ...
    public class RequiredWithShadowFk
    {
        ...
        public class BlogContext0 : DbContext
        {
            ...
            protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
                => optionsBuilder.UseSqlite($"DataSource = ./Sqlite3/RequiredShadow{GetType().Name}.db");
    ...
    public class OptionalWithShadowFk
    {
        ...
        public class BlogContext0 : DbContext
        {
            ...
            protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
                => optionsBuilder.UseSqlite($"DataSource = ./Sqlite3/OptionalShadow{GetType().Name}.db");
    ...
    public class RequiredNoNavigationToPrincipal
    {
        ...
        public class BlogContext0 : DbContext
        {
            ...
            protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
                => optionsBuilder.UseSqlite($"DataSource = ./Sqlite3/RequiredNoNavigationToPrincipal{GetType().Name}.db");
        }
    ...
    public class OptionalNoNavigationToPrincipal
    {
        ...
        public class BlogContext0 : DbContext
        {
            ...
            protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
                => optionsBuilder.UseSqlite($"DataSource = ./Sqlite3/OptionalNoNavigationToPrincipal{GetType().Name}.db");
        }
    ...
    public class RequiredWithShadowFkAndNoNavigationToPrincipal
    {
        ...
        public class BlogContext0 : DbContext
        {
            ...
            protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
                => optionsBuilder.UseSqlite($"DataSource = ./Sqlite3/RequiredShadowNoNavigationToPrincipal{GetType().Name}.db");
    ...
    public class OptionalWithShadowFkAndNoNavigationToPrincipal
    {
        ...
        public class BlogContext0 : DbContext
        {
            ...
            protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
                => optionsBuilder.UseSqlite($"DataSource = ./Sqlite3/OptionalShadowNoNavigationToPrincipal{GetType().Name}.db");
    ...
    public class RequiredNoNavigationToDependents
    {
        ...
        public class BlogContext0 : DbContext
        {
            ...
            protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
                => optionsBuilder.UseSqlite($"DataSource = ./Sqlite3/RequiredNoNavigationToDependents{GetType().Name}.db");
    ...
    public class OptionalNoNavigationToDependents
    {
        ...
        public class BlogContext0 : DbContext
        {
            ...
            protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
                => optionsBuilder.UseSqlite($"DataSource = ./Sqlite3/OptionalNoNavigationToDependents{GetType().Name}.db");
    ...
    public class RequiredWithShadowFkAndNoNavigationToDependents
    {
        ...
        public class BlogContext0 : DbContext
        {
            ...
            protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
                => optionsBuilder.UseSqlite($"DataSource = ./Sqlite3/RequiredShadowNoNavigationToDependents{GetType().Name}.db");
    ...
    public class RequiredNoNavigations
    {
        ...
        public class BlogContext0 : DbContext
        {
            ...
            protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
                => optionsBuilder.UseSqlite($"DataSource = ./Sqlite3/RequiredNoNavigations{GetType().Name}.db");
    ...
    public class OptionalNoNavigations
    {
        ...
        public class BlogContext0 : DbContext
        {
            ...
            protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
                => optionsBuilder.UseSqlite($"DataSource = ./Sqlite3/OptionalNoNavigations{GetType().Name}.db");
    ...
    public class RequiredWithShadowFkAndNoNavigations
    {
        ...
        public class BlogContext0 : DbContext
        {
            ...
            protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
                => optionsBuilder.UseSqlite($"DataSource = ./Sqlite3/RequiredShadowNoNavigations{GetType().Name}.db");
    ...
    public class RequiredWithAlternateKey
    {
        ...
        public class BlogContext0 : DbContext
        {
            ...
            protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
                => optionsBuilder.UseSqlite($"DataSource = ./Sqlite3/RequiredWithAlternateKey{GetType().Name}.db");
    ...
    public class OptionalWithAlternateKey
    {
        ...
        public class BlogContext0 : DbContext
        {
            ...
            protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
                => optionsBuilder.UseSqlite($"DataSource = ./Sqlite3/OptionalWithAlternateKey{GetType().Name}.db");
    ...
    public class RequiredWithShadowFkWithAlternateKey
    {
        ...
        public class BlogContext0 : DbContext
        {
            ...
            protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
                => optionsBuilder.UseSqlite($"DataSource = ./Sqlite3/RequiredShadowWithAlternateKey{GetType().Name}.db");
    ...
    public class OptionalWithShadowFkWithAlternateKey
    {
        ...
        public class BlogContext0 : DbContext
        {
            ...
            protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
                => optionsBuilder.UseSqlite($"DataSource = ./Sqlite3/OptionalShadowWithAlternateKey{GetType().Name}.db");
    ...
    public class RequiredWithCompositeKey
    {
        ...
        public class BlogContext0 : DbContext
        {
            ...
            protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
                => optionsBuilder.UseSqlite($"DataSource = ./Sqlite3/RequiredWithCompositeKey{GetType().Name}.db");
    ...
    public class OptionalWithCompositeKey
    {
        ...
        public class BlogContext0 : DbContext
        {
            ...
            protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
                => optionsBuilder.UseSqlite($"DataSource = ./Sqlite3/OptionalWithCompositeKey{GetType().Name}.db");
    ...
    public class RequiredWithShadowFkWithCompositeKey
    {
        ...
        public class BlogContext0 : DbContext
        {
            ...
            protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
                => optionsBuilder.UseSqlite($"DataSource = ./Sqlite3/RequiredShadowWithCompositeKey{GetType().Name}.db");
    ...
    public class OptionalWithShadowFkWithCompositeKey
    {
        ...
        public class BlogContext0 : DbContext
        {
            ...
            protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
                => optionsBuilder.UseSqlite($"DataSource = ./Sqlite3/OptionalShadowWithCompositeKey{GetType().Name}.db");
    ...
    public class SelfReferencing
    {
        ...
        public class PersonContext0 : DbContext
        {
            ...
            protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
                => optionsBuilder.UseSqlite($"DataSource = ./Sqlite3/SelfReferencing{GetType().Name}.db");
        }
